...
from db import register_user, get_test, submit_answers, check_already_submitted
from test_checker import parse_answers, check_answers, format_detailed_result
...
async def check_sub_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await show_main_menu_msg(query.message, user)
...
async def show_main_menu_msg(message, user):
    admin_id = int(os.getenv("ADMIN_ID", "0"))
    keyboard = [
        [InlineKeyboardButton("📝 Testga kirish", callback_data="enter_test")],
        [InlineKeyboardButton("ℹ️ Bot haqida", callback_data="about")],
